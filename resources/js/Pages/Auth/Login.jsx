    ...
    return (
        <div className="mx-auto flex max-w-md flex-col justify-center py-10">
            <div className="mb-8 text-center">
                ...
                <h1 className="mt-4 text-2xl font-bold text-stone-900 dark:text-stone-100">Connexion</h1>
                <p className="mt-1 text-sm text-stone-500 dark:text-stone-400">Accédez à votre compte.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm dark:border-stone-800 dark:bg-stone-900">
                <a
                    href="/auth/google"
                    className="flex w-full items-center justify-center gap-3 rounded-lg border border-stone-300 bg-white px-4 py-2.5 text-sm font-medium text-stone-700 shadow-sm hover:bg-stone-50 dark:border-stone-600 dark:bg-stone-800 dark:text-stone-200 dark:hover:bg-stone-700"
                >
                ...
                <div className="relative my-4">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="bg-white px-2 text-stone-400 dark:bg-stone-900 dark:text-stone-500">ou</span>
                    </div>
                </div>
            ...
            <p className="mt-5 text-center text-sm text-stone-600 dark:text-stone-400">
                ...
                <Link href="/register" className="font-medium text-teal-700 hover:underline dark:text-teal-300">
                    Créer un compte
                </Link>
            </p>
        </div>
